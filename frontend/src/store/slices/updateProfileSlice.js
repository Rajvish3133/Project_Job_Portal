...
export const updateProfile = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.put(
      "https://project-job-portal-backend-2slk.onrender.com/api/v1/user/update/profile",
      data,
      {
...
export const updatePassword = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.put(
      "https://project-job-portal-backend-2slk.onrender.com/api/v1/user/update/password",
      data,
      {
        withCredentials: true,
