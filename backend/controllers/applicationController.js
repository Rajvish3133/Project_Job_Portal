...
export const jobSeekerGetApplication = catchAsyncErrors(async(req, res, next)=>{
    const {_id}= req.user;
    const applications = await Application.find({
...
export const deleteAppliaction = catchAsyncErrors(async(req, res, next)=>{
  const { id }= req.params;
  ...
  switch(role){
    ...
    default:
        console.log("Default case for application deletion");    
  }  
